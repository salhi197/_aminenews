	...
	<div class="anwp-pg-post-teaser__content flex-grow-1 d-flex flex-column pt-1">
		...
		*/
		...
		if ( 'yes' === $data->show_category && is_array( $post_categories ) && isset( $post_categories[0]->term_id ) ) :
			?>
			<div class="anwp-pg-post-teaser__top-meta d-flex mb-1">
				<?php anwp_post_grid()->elements->render_post_category_link( $post_categories[0], 'anwp-pg-post-teaser__category-wrapper' ); ?>
			</div>
		<?php endif; ?>
